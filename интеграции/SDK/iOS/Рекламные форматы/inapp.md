...
При загрузке рекламы необходимо передавать padId, который можно получить в рекламной админке либо от менеджера. Для отладки можно использовать тестовые padId. Смотрите подробнее в [Отладка интеграции](#5-отладка-интеграции)
...
# 4. Реакция на события с рекламой
