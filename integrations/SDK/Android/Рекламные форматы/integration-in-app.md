...
| Цвет                                | Описание                                 |
|-------------------------------------|------------------------------------------|
| surface.primary.default             | цвет фона диалога с рекламой             |
| loader.fill.primary                 | цвет прогресс-бара на диалоге с рекламой |
| button.text.primary.default         | цвет текста для кнопки с диплинком       |
| button.text.secondary.default       | цвет текста для кнопки с промокодом      |
| button.background.primary.default   | цвет фона для кнопки с диплинком         |
| button.background.secondary.default | цвет фона для кнопки с диплинком         |
